...
public class Bagian2_m4 extends AppCompatActivity {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bagian2_m5);

        Button home = findViewById(R.id.btnhome);
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Bagian2_m4.this, MenuMateri.class));
                finish();
            }
        });
    }
...
//                    mp.start();
                    Intent i = new Intent(Bagian2_m4.this, Bagian3_m4.class);
                    startActivity(i);
                    overridePendingTransition(R.anim.slide_right,R.anim.slide_left_out);
                    finish();
                }
                else if(x1 < x2){
                    Intent i = new Intent(Bagian2_m4.this, Bagian1_m4.class);
                    startActivity(i);
