...
import com.example.panduanpraktikum.materi3.Bagian1_m3;

public class Bagian1_m4 extends AppCompatActivity {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bagian1_m4);

        ImageButton home = findViewById(R.id.home);
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Bagian1_m4.this, MenuMateri.class));
                finish();
            }
        });
    }
...
//                    mp.start();
                    Intent i = new Intent(Bagian1_m4.this, Bagian2_m4.class);
                    startActivity(i);
