...
public class Bagian2_m2 extends AppCompatActivity {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bagian2_m3);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Bagian2_m2.this, MenuMateri.class));
                finish();
            }
        });
    }
...
//                    mp.start();
                    Intent i = new Intent(Bagian2_m2.this, Bagian3_m2.class);
                    startActivity(i);
                    overridePendingTransition(R.anim.slide_right,R.anim.slide_left_out);
                    finish();
                }
                else if(x1 < x2){
                    Intent i = new Intent(Bagian2_m2.this, Bagian1_m2.class);
                    startActivity(i);
