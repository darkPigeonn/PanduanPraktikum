...
public class Bagian4_m2 extends AppCompatActivity {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bagian4_m2);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Bagian4_m2.this, MenuMateri.class));
                finish();
            }
        });
    }
...
//                else
                    if(x1 < x2){
                    Intent i = new Intent(Bagian4_m2.this, Bagian3_m2.class);
                    startActivity(i);
