...
public class Bagian1_m1 extends AppCompatActivity {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Bagian1_m1.this, MenuMateri.class));
                finish();
            }
        });
    }
...
//                    mp.start();
                    Intent i = new Intent(Bagian1_m1.this, Bagian2_m1.class);
                    startActivity(i);
